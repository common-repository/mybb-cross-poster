...
class MyBBXP {
	...
	function the_content_filter($content) {
		global $wpdb, $post;
		if (get_post_meta($post->ID, 'mybbxp_active', true) !== '1' || !is_single()) {
			return $content;
		}	 
	...
	function add_meta_boxes_action() {
		add_meta_box('mybbxp', 'MyBB Cross-Poster', array($this, 'cross_post_form'), 'post', 'normal', 'high');
		add_meta_box('mybbxp', 'MyBB Cross-Poster', array($this, 'cross_post_form'), 'page', 'normal', 'high');
	}
