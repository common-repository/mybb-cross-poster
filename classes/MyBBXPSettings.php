...
class MyBBXPSettings {
	...
	function admin_menu_action() {
		$hook = add_options_page('MyBB Cross-Poster Settings', 'MyBB Cross-Poster', 'manage_options', 'mybbxp_settings_page', array($this, 'settings_page')); // $page_title, $menu_title, $capability, $menu_slug, $function
...
?>
<div class="wrap">
	<h2>MyBB Cross-Poster Settings Page</h2>
