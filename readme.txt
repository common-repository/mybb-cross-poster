=== MyBB Cross-Poster ===
Contributors: gmmedia
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=FJXKWV2PJ5PGG
Tags: mybb, wordpress, forum, mybbxp, cross-posting, cross, comments, sidebar, widget
...
4. Find the new "MyBB Cross-Poster" box on post/page adding/editing and edit its content to your liking
...
1. The Cross-Poster options page.
2. The sidebar widget.

== Changelog ==

= 1.1 =
* Higher timout for the cross poster

= 1.0 =
* First release for Wordpress 4.3.1 and MyBB 1.8
* Updated to the new MyBB table structure.
* Remove Shortcodes with exclusion for: QUOTE, URL and IMG BB-Codes
